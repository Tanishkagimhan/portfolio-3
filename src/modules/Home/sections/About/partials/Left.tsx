  ...
  return (
    <motion.div variants={fadeTop} {...motionStep} className='col-span-3' >
      ...
      <div className='space-y-4 mt-7 text-slate-400' >
        ...
        <p>Hello! My name is Tanishka and I enjoy creating things that live on the internet. My interest in web development started back in 2020 when I decided to try editing custom Tumblr themes — turns out hacking together a custom reblog button taught me a lot about HTML & CSS!</p>
